...
function tzlib_get_content(e) {
  ...
  return (3 !== e.length ||
    ...
    ? 3 === e.length
      ...
      : [
          tzlibZonesDB['' + e[0]][0],
          tzlib_enrich_data(tzlibZonesDetailsDB[tzlibZonesDB['' + e[0]][1]]),
        ]
    ...
    : ((n = 'TZID=' + (e = '' == t[0] ? e : t[0])),
      (e = [
        'BEGIN:VTIMEZONE\r\nTZID:' +
          ...
          e +
          '\r\nLAST-MODIFIED:' +
          t[1].replace(/[^\w_\-:,;=+/<br>]/g, '').replace(/<br>/g, '\r\n') +
          'END:VTIMEZONE',
        n,
      ]),
    ...
    t =
      '-' == s['' + d].day[0]
        ? ((g = s['' + d].day.substr(2, 2)),
          ...
          p['' + g]['' + e])
        : ((g = s['' + d].day.substr(1, 2)), p['' + g][s['' + d].day[0]]);
  return (
    t < l || (l == t && a >= s['' + d].hour)
      ? s['' + d]
      : ((e = 1 == d ? 2 : 1), s['' + e])
  ...
  if (null != e.recurrence && '' != e.recurrence)
    if (
      ...
      if (/^RRULE:/i.test(e.recurrence)) {
        ...
        (null != e.recurrence_interval && '' != e.recurrence_interval) ||
...
function atcb_decorate_data_description(e, a) {
  return (
    null != e.dates['' + a].description && '' != e.dates['' + a].description
      ? ((e.dates['' + a].descriptionHtmlFree = atcb_rewrite_html_elements(
...
function atcb_decorate_data_extend(a) {
  for (let e = 0; e < a.dates.length; e++)
    (null != (a = atcb_decorate_data_description(a, e)).dates['' + e].name &&
      '' != a.dates['' + e].name) ||
      (a.dates['' + e].name = a.name),
      null == a.dates['' + e].status
        ? (a.dates['' + e].status = a.status.toUpperCase())
        : (a.dates['' + e].status = a.dates['' + e].status.toUpperCase()),
  ...
  return (
    ['start', 'end'].forEach(function (e) {
      ...
      null != n[e + 'Date'] &&
        ...
        null != n[e + 'Time'] &&
          8 === n[e + 'Time'].length &&
          ((a = n[e + 'Time']), (n[e + 'Time'] = a.substring(0, a.length - 3))),
...
function atcb_validate_date_blocks(a, t) {
  for (let e = 0; e < a.dates.length; e++) {
    var n =
      1 == a.dates.length
        ? ''
        : ' [dates array object #' + (e + 1) + '/' + a.dates.length + '] ';
...
function atcb_validate_sequence(e, a, t, n) {
  return (
    /^\d+$/.test(e.dates['' + t].sequence) ||
      (console.log(
        a + ': sequence needs to be a number. Used the default 0 instead' + n
      ),
  ...
  return (
    !!e.every(function (e) {
      ...
      return 10 !== t.dates['' + o]['' + e].length
        ? (console.error(n + ' failed: date misspelled [-> YYYY-MM-DD]' + i),
          !1)
    ...
    !!['startTime', 'endTime'].every(function (e) {
      if (null != t.dates['' + o]['' + e]) {
        if (5 !== t.dates['' + o]['' + e].length)
          return (
            console.error(n + ' failed: time misspelled [-> HH:MM]' + i), !1
          );
    ...
    (null == t.dates['' + o].startTime && null != t.dates['' + o].endTime)
      ...
      : !(l.endDate < l.startDate) ||
        (console.error(n + ' failed: end date before start date' + i), !1))
  );
}
function atcb_validate_rrule(e, a) {
  return null != e.recurrence && '' != e.recurrence && 1 < e.dates.length
    ? (console.error(a + ' failed: RRULE and multi-date set at the same time'),
      !1)
    : null == e.recurrence ||
      '' == e.recurrence ||
    ...
    ? null == e.recurrence_interval ||
            ...
            ? null == e.recurrence_byMonthDay ||
              ...
              ? null == e.recurrence_byDay ||
                ...
                ? !(
                  ...
                  (console.error(
                    a + ' failed: recurrence data (weekstart) misspelled'
                  ),
                  !1)
                : (console.error(
                    a + ' failed: recurrence data (byDay) misspelled'
                  ),
                  !1)
              : (console.error(
                  a + ' failed: recurrence data (byMonthDay) misspelled'
                ),
                !1)
            : (console.error(
                a + ' failed: recurrence data (byMonth) misspelled'
              ),
              !1)
          : (console.error(
      ...
      : (console.error(a + ' failed: recurrence data (interval) misspelled'),
        !1)
...
function atcb_close(a = !1) {
  ...
  if (1 < t.length) {
    document
      .querySelectorAll('.atcb-modal[data-modal-nr="' + t.length + '"]')[0]
      .remove();
    ...
    t &&
      ...
      Array.from(document.querySelectorAll('.atcb-list-wrapper'))
        ...
        .concat(
          Array.from(document.querySelectorAll('.atcb-modal[data-modal-nr]'))
        )
        .concat(
          Array.from(
            document.querySelectorAll('#add-to-calendar-button-reference')
          )
        )
  ...
  switch (n) {
    ...
    case 'close':
      (t.id = a.identifier + '-close'),
        ...
        t.addEventListener('keyup', function (e) {
          'Enter' == e.key &&
            (e.preventDefault(), atcb_toggle('close', a, 'all', !0));
        });
  }
  ...
  n.classList.add('atcb-button'),
    ...
    1 === a.options.length
      ? (n.classList.add('atcb-single'),
        atcb_generate_label(a, n, a.options[0], a.iconButton, a.label, !0))
      : (atcb_generate_label(a, n, 'trigger', a.iconButton, a.label),
        ...
        n.appendChild(t)),
    a.checkmark &&
      ((t = document.createElement('div')).classList.add('atcb-checkmark'),
  ...
  for (let e = 0; e < a.dates.length; e++) {
    var l = [],
      r =
        ...
        l.push('"@type":"Event"'),
        1 < a.dates.length &&
          l.push('"@id":"' + a.name.replace(/\s/g, '') + '-' + (e + 1) + '"'),
        ...
        a.dates['' + e].descriptionHtmlFree &&
          l.push('"description":"' + a.dates['' + e].descriptionHtmlFree + '"'),
...
function atcb_create_modal(n, e = '', a, t = '', o = [], i = [], l = !1) {
  var r =
      ...
      atcb_generate_bg_overlay('modal', 'click', n.lightMode, n.background),
    s =
    ...
    e =
      ...
      '' != e &&
        1 == n.iconModal &&
        ((r = document.createElement('div')).classList.add('atcb-modal-icon'),
  ...
  if (
    ...
    d.appendChild(e),
    '' != t &&
      ((r = document.createElement('div')).classList.add('atcb-modal-content'),
      (r.innerHTML = t),
      d.appendChild(r)),
    1 < i.length)
  ) {
...
function atcb_generate_date_button(u, e, m = 'all') {
  ...
  var a = (function () {
      ...
      o.allday ||
        ...
        t == n ||
        (r = ' (' + t + ')'),
        ((i.allday || Intl.DateTimeFormat().resolvedOptions().timeZone == n) &&
          t == n) ||
          (s = ' (' + n + ')');
  ...
  o.classList.add('atcb-date-btn-hover'),
    ...
    r.appendChild(o),
    u.checkmark &&
      ((s = document.createElement('div')).classList.add('atcb-checkmark'),
...
function atcb_generate_multidate_links(a, t, e, n) {
  if (
    ...
    !t.dates.every(function (e) {
      return (
        'CANCELLED' != e.status && (null == e.organizer || '' == e.organizer)
      );
    })
  ) {
    if (!n) {
...
function atcb_set_fully_successful(e, a) {
  ...
  e && e.classList.add('atcb-saved'),
    atcb_saved_hook(),
    a &&
      document.querySelectorAll('.atcb-modal[data-modal-nr]').length < 2 &&
      atcb_toggle('close');
}
    ...
    for (let e = l; e <= r; e++) {
      ...
      c.push('BEGIN:VEVENT'),
        ...
        null != a.dates['' + e].availability &&
          '' != a.dates['' + e].availability &&
          ((s =
            'free' == a.dates['' + e].availability ? 'TRANSPARENT' : 'OPAQUE'),
          c.push('TRANSP:' + s)),
    ...
    );
  {
    ...
    if (null != e.timeZone && '' != e.timeZone) {
      ...
      var n =
          ...
          parseInt(t[0] + 1) *
          (60 *
            (60 * parseInt(t.substr(1, 2)) + parseInt(t.substr(3, 2))) *
            1e3),
        r =
          -1 *
          parseInt(e[0] + 1) *
          (60 *
            (60 * parseInt(e.substr(1, 2)) + parseInt(e.substr(3, 2))) *
            1e3);
    ...
    d =
      ...
      !0 !== o || a.classList.contains('atcb-dropoverlay')
        ? ((a.style.minWidth = s.width + 20 + 'px'),
          (r = a.getBoundingClientRect()),
          (a.style.top =
            window.scrollY + s.top + s.height / 2 - r.height / 2 + 'px'),
...
function atcb_throttle(n, o = 10) {
  ...
  return (...e) => {
    ...
    return (
      t <= 0 || o < t
        ? (l && (clearTimeout(l), (l = null)), (r = a), (i = n.apply(this, e)))
        : (l = l || setTimeout(s, t)),
      i
    );
  };
...
const i18nStrings = {
  ...
  fr: {
    ...
    'modal.multidate.text':
      "Ajoute les différents rendez-vous dans l'ordre à ton agenda:",
    Event: 'Terminaison',
  ...
  zh: {
    ...
    'modal.crios.ical.text':
      '不幸的是，iOS 上的 Chrome 在我们生成日历文件的方式上存在问题。',
    'modal.crios.ical.steps':
  ...
  ar: {
    ...
    'modal.crios.ical.text':
      'لسوء الحظ ، يواجه Chrome على iOS مشاكل في طريقة إنشاء ملف التقويم',
    'modal.crios.ical.steps':
  ...
  no: {
    ...
    'modal.crios.ical.text':
      'Dessverre har Chrome på iOS problemer med måten vi genererer kalenderfilen på.',
    'modal.crios.ical.steps':
  ...
  sv: {
    ...
    'modal.crios.ical.text':
      'Tyvärr har Chrome på iOS problem med hur vi genererar kalenderfilen.',
    'modal.crios.ical.steps':
  ...
  ja: {
    ...
    'modal.crios.ical.text':
      '残念ながら、iOS版Chromeでは、カレンダーファイルの生成方法に問題があります。',
    'modal.crios.ical.steps':
  ...
  ko: {
    ...
    'modal.crios.ical.text':
      '불행히도 iOS의 Chrome은 캘린더 파일을 생성하는 방식에 문제가 있습니다.',
    'modal.crios.ical.steps':
  ...
  vi: {
    ...
    'modal.crios.ical.text':
      'Rất tiếc, Chrome trên iOS gặp sự cố với cách chúng tôi tạo tệp lịch.',
    'modal.crios.ical.steps':
              ...
              atcb_patch_config(
                (function () {
                  try {
                    return JSON.parse(
                      atcb_secure_content(
                        o[parseInt(e)].innerHTML.replace(/(\r\n|\n|\r)/g, ''),
                        !1
                      )
                    );
                  } catch (e) {
...
function atcb_init_log_msg() {
  atcbInitialInit ||
    (console.log(
      'Add to Calendar Button Script initialized (version ' + atcbVersion + ')'
    ),
    console.log(
        ...
        if (t.classList.contains('atcb-list-item'))
          'ArrowDown' === a.key && t.dataset.optionNumber < n
            ...
            0 < e &&
              document
                .querySelector(
                  '.atcb-list-item[data-option-number="' + e + '"]'
                )
                .focus();
        else
          switch ((a.preventDefault(), a.key)) {
            case 'ArrowDown':
              document
                .querySelector('.atcb-list-item[data-option-number="1"]')
                .focus();
              break;
            case 'ArrowUp':
              document
    ...
    window.addEventListener(
      ...
      atcb_throttle(() => {
        var e,
          ...
          a =
            (null != a && (atcb_set_fullsize(a), atcb_manage_body_scroll()),
